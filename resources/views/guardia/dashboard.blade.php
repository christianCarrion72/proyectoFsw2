...
@section('content')
    <div class="container-fluid">
        <h1 class="mt-4">Dashboard de Vigilancia Anti-Bullying</h1>
        ...
        <!-- Otros gráficos comentados para debugging
        <div class="row">
            <div class="col-xl-6">
                <div class="card mb-4">
                    <div class="card-header">
                        <i class="fas fa-map-marker-alt mr-1"></i>Incidentes por Ubicación
                    </div>
                    <div class="card-body"><canvas id="locationChart" width="100%" height="300"></canvas></div>
                </div>
            </div>
            <div class="col-xl-6">
                <div class="card mb-4">
                    <div class="card-header">
                        <i class="fas fa-users mr-1"></i>Incidentes por Grupo de Edad
                    </div>
                    <div class="card-body"><canvas id="ageGroupChart" width="100%" height="300"></canvas></div>
                </div>
            </div>
        </div>
        -->
...
$(document).ready(function() {
    ...
    setTimeout(function() {
        if (typeof toastr !== 'undefined') {
            toastr.info('Dashboard de Vigilancia Anti-Bullying cargado correctamente');
        }
    }, 1000);
});
</script>
